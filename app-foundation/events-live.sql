...
--   2. clears the 4 dummy seed events (+ their meetings/attendance)
--   3. turns on Row-Level Security for events/meetings/attendance
-- After this, events you create in the app persist here, and RLS enforces:
--   read = any chapter member · create/edit/delete = exec.
-- (RSVPs are handled in Partiful — the app stores no per-member RSVP.)
-- ============================================================================
...
-- 2. Clear the dummy seed events. attendance cascades on meeting;
--    points_entries.event_id is set-null (entries kept, link cleared).
